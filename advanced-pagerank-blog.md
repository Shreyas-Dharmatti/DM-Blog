...
PageRank seeks a vector r where each component r[i] represents page i's importance. The fundamental insight: **PageRank is the principal eigenvector of the Google matrix**.
